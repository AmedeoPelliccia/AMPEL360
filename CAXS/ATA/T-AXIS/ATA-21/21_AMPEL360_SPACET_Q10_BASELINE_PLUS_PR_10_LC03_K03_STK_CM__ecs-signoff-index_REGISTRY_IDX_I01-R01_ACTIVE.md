...
| SO-LC03-004 | LC03 | Gate-ICD | CO₂ Power Support Interface Baseline Approval | DEC | STK_CM | DRAFT | CO₂ loop power support interface spec baseline approved | EV-CEGT-001 (co2-power-support-interfaces); EV-PHM-001 (thermal-envelope) | CAXS/AoR/STK_CM/DECISIONS/21_AMPEL360_SPACET_Q10_BASELINE_PLUS_PR_10_LC03_K03_STK_CM__co2-power-support-interface-baseline-approval_SIGNOFF_DEC_I01-R01_DRAFT.md |
| SO-LC06-005 | LC06 | Gate-EVIDENCE | CO₂ Energy Balance and Claim Boundary Acceptance | DEC | STK_CERT | DRAFT | Evidence accepts power support claim (storage not energy source, no thrust) | EV-CEGT-002 (energy-balance); EV-CEGT-001 (interface-spec); EV-PHM-001 (thermal-envelope) | CAXS/AoR/STK_CERT/DECISIONS/21_AMPEL360_SPACET_Q10_BASELINE_PLUS_PR_10_LC06_K07_STK_CERT__co2-claim-boundary-acceptance_SIGNOFF_DEC_I01-R01_DRAFT.md |
