# STK_PMO — PORTAL Tool Access Registry

**AoR:** STK_PMO (Program Management Office)  
**Status:** ACTIVE  
**Version:** 1.0  
...
This registry documents the tools accessible through the CA360º Portal for Program Management Office activities, governed by the Tool Access & Licensing Fabric (TALF).

## Required Tools

The following tools are cataloged for STK_PMO in the portal-wide tool catalog:

- `ms-project-web` (see CAXS/INFRASTRUCTURE/access/tool_catalog.yaml)
