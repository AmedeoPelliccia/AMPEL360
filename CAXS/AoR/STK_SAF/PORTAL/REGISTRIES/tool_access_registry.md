# STK_SAF — PORTAL Tool Access Registry
...
This registry documents the tools accessible through the CA360º Portal for Safety activities, governed by the Tool Access & Licensing Fabric (TALF).

## Required Tools

The following tools are cataloged for STK_SAF in the portal-wide tool catalog:

- `medini-analyze-vdi` (see CAXS/INFRASTRUCTURE/access/tool_catalog.yaml)
