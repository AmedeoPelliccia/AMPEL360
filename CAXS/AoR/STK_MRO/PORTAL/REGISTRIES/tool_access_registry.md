# STK_MRO — PORTAL Tool Access Registry

**AoR:** STK_MRO (Maintenance, Repair & Overhaul)  
**Status:** ACTIVE  
**Version:** 1.0  
...
This registry documents the tools accessible through the CA360º Portal for Maintenance, Repair & Overhaul activities, governed by the Tool Access & Licensing Fabric (TALF).

## Required Tools

The following tools are cataloged for STK_MRO in the portal-wide tool catalog:

- `ata-ispec-2200-web` (see CAXS/INFRASTRUCTURE/access/tool_catalog.yaml)
