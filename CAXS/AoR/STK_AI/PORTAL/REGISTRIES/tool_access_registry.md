# STK_AI — PORTAL Tool Access Registry

**AoR:** STK_AI (AI/ML Engineering)  
**Status:** ACTIVE  
**Version:** 1.0  
...
This registry documents the tools accessible through the CA360º Portal for AI/ML Engineering activities, governed by the Tool Access & Licensing Fabric (TALF).

## Required Tools

The following tools are cataloged for STK_AI in the portal-wide tool catalog:

- `pytorch-jupyter-container` (see CAXS/INFRASTRUCTURE/access/tool_catalog.yaml)
- `mlflow-platform-web` (see CAXS/INFRASTRUCTURE/access/tool_catalog.yaml)
