# STK_DAB — PORTAL Tool Access Registry

**AoR:** STK_DAB (Digital Applications & Blockchains)  
**Status:** ACTIVE  
**Version:** 1.0  
...
This registry documents the tools accessible through the CA360º Portal for Digital Applications & Blockchains activities, governed by the Tool Access & Licensing Fabric (TALF).

## Required Tools

The following tools are cataloged for STK_DAB in the portal-wide tool catalog:

- `vscode-dev-container` (see CAXS/INFRASTRUCTURE/access/tool_catalog.yaml)
- `python-jupyter-container` (see CAXS/INFRASTRUCTURE/access/tool_catalog.yaml)
- `github-enterprise-web` (see CAXS/INFRASTRUCTURE/access/tool_catalog.yaml)
