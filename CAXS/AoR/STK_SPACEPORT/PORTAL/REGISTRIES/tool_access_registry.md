# STK_SPACEPORT — PORTAL Tool Access Registry

**AoR:** STK_SPACEPORT (Spaceport & Ground Segment)  
**Status:** ACTIVE  
**Version:** 1.0  
...
This registry documents the tools accessible through the CA360º Portal for Spaceport & Ground Segment activities, governed by the Tool Access & Licensing Fabric (TALF).

## Required Tools

The following tools are cataloged for STK_SPACEPORT in the portal-wide tool catalog:

- `range-safety-analysis-vdi` (see CAXS/INFRASTRUCTURE/access/tool_catalog.yaml)
- `python-jupyter-vdi` (see CAXS/INFRASTRUCTURE/access/tool_catalog.yaml)
