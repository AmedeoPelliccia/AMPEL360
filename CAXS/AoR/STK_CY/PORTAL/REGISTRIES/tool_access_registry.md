# STK_CY — PORTAL Tool Access Registry

**AoR:** STK_CY (Cybersecurity)  
**Status:** ACTIVE  
**Version:** 1.0  
...
This registry documents the tools accessible through the CA360º Portal for Cybersecurity activities, governed by the Tool Access & Licensing Fabric (TALF).

## Required Tools

The following tools are cataloged for STK_CY in the portal-wide tool catalog:

- `burp-suite-pro-vdi` (see CAXS/INFRASTRUCTURE/access/tool_catalog.yaml)
