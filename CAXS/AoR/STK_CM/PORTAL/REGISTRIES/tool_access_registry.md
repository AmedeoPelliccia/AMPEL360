# STK_CM — PORTAL Tool Access Registry
...
This registry documents the tools accessible through the CA360º Portal for Configuration Management activities, governed by the Tool Access & Licensing Fabric (TALF).

## Required Tools

The following tools are cataloged for STK_CM in the portal-wide tool catalog:
