...
This index tracks formal approvals and signoffs for STK_CM deliverables. All CATEGORY=SIGNOFF artifacts must be listed here with approval evidence.

## Signoff Authority

**Primary Authority:** STK_CM  
**Secondary Approval (Required):** STK_CERT  
...
```yaml
signoff_id: SGN-STK_CM-XXX
deliverable_ref: ""
deliverable_path: "CAXS/..."
approver: STK_CM
co_approver: STK_CERT
...
2. **Review:** STK_CM technical review complete
3. **Co-Review:** STK_CERT governance review
