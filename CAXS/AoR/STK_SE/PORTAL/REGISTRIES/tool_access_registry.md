# STK_SE — PORTAL Tool Access Registry

**AoR:** STK_SE (Systems Engineering)  
**Status:** ACTIVE  
**Version:** 1.0  
...
This registry documents the tools accessible through the CA360º Portal for Systems Engineering activities, governed by the Tool Access & Licensing Fabric (TALF).

## Required Tools

The following tools are cataloged for STK_SE in the portal-wide tool catalog:

- `cameo-systems-modeler-vdi` (see CAXS/INFRASTRUCTURE/access/tool_catalog.yaml)
- `doors-ng-web` (see CAXS/INFRASTRUCTURE/access/tool_catalog.yaml)
