# STK_CEGT — PORTAL Tool Access Registry

**AoR:** STK_CEGT (Circular Economy & Green Tech)  
**Status:** ACTIVE  
**Version:** 1.0  
...
This registry documents the tools accessible through the CA360º Portal for Circular Economy & Green Tech activities, governed by the Tool Access & Licensing Fabric (TALF).

## Required Tools

The following tools are cataloged for STK_CEGT in the portal-wide tool catalog:

- `simapro-lca-vdi` (see CAXS/INFRASTRUCTURE/access/tool_catalog.yaml)
