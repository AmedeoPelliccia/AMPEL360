# STK_CERT — PORTAL Tool Access Registry
...
This registry documents the tools accessible through the CA360º Portal for Certification activities, governed by the Tool Access & Licensing Fabric (TALF).

## Required Tools

The following tools are cataloged for STK_CERT in the portal-wide tool catalog:

- `compliance-tracker-web` (see CAXS/INFRASTRUCTURE/access/tool_catalog.yaml)
